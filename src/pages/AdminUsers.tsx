...
import { getAllUsersForAdmin, updateUserProfile, updateUserKycStatus, getNetworkMembers, deleteUser, getUserNetworkMembers, setToStorage } from '../utils/localStorageService';
...
const AdminUsers: React.FC = () => {
  ...
  const loadUserData = () => {
    ...
    // Remove setting of general network data, as we'll load specific user data when needed
  ...
  const handleUpdateKycStatus = (userId: string, status: KYCStatus) => {
    const success = updateUserKycStatus(userId, status);
    if (success) {
      loadUserData();
  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        ...
        <p className="text-neutral-600">Manage users and view their referral networks</p>
      </div>
            ...
            <Card title="Network Structure">
              ...
              <div className="text-center py-2 mb-4">
                ...
                <p className="text-sm text-neutral-500">
                  Team size: {selectedUser.teamSize} members
                </p>
              </div>
